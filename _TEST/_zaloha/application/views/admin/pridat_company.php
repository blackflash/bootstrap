<div id="main-content"> <!-- Main Content Section with everything -->
	...
	<a href="<?php echo base_url().$basicInfo["main_controller"]; ?>/loadAdminPage/companies" class="linkBack">Späť</a>
	<div class="clear"></div>
	...
	<table>
		...
		<tr>
			<td><?php echo form_label('ID Miesta:', $place_id['id']); ?></td>
			<td><?php echo form_input($place_id); ?></td>
			<td style="color: red;"  class="errorLogin">
				<?php echo form_error($place_id['name']); ?><?php echo isset($errors[$place_id['name']])?$errors[$place_id['name']]:''; ?>
			</td>
		</tr>
		<tr>
